    ...
    <section className="relative min-h-screen flex flex-col items-center pt-32 pb-16 overflow-hidden" id="hero">
      ...
      >
        <img
          ...
          alt="UPSERA web design agency in Cochin"
          width="1920"
          height="1080"
          fetchPriority="high"
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center">
        <motion.div
          ...
          id="hero-content"
        >
          <div className="mb-6 inline-flex items-center space-x-3 text-[9px] md:text-[11px] uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/50">
            <span className="w-4 md:w-8 h-[1px] bg-white/30"></span>
            <span className="px-2">EVERY GREAT BUSINESS HAS A STORY. LET'S WRITE YOURS.</span>
            <span className="w-4 md:w-8 h-[1px] bg-white/30"></span>
          </div>
